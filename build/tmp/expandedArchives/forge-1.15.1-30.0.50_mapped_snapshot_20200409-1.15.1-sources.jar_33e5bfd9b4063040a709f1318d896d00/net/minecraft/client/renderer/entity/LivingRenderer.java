...
public abstract class LivingRenderer<T extends LivingEntity, M extends EntityModel<T>> extends EntityRenderer<T> implements IEntityRenderer<T, M> {
   ...
   public void render(T entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      if (net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.client.event.RenderLivingEvent.Pre<T, M>(entityIn, this, partialTicks, matrixStackIn))) return;
      matrixStackIn.push();
      ...
      boolean flag1 = this.isVisible(entityIn, false);
      boolean flag2 = !flag1 && !entityIn.isInvisibleToPlayer(Minecraft.getInstance().player);
      ...
      if (flag2) {
         ...
         rendertype = this.entityModel.getRenderType(resourcelocation);
      } else {
      ...
      net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.client.event.RenderLivingEvent.Post<T, M>(entityIn, this, partialTicks, matrixStackIn));
   }
   ...
   protected boolean isVisible(T livingEntityIn, boolean p_225622_2_) {
      return !livingEntityIn.isInvisible() || p_225622_2_;
   }
