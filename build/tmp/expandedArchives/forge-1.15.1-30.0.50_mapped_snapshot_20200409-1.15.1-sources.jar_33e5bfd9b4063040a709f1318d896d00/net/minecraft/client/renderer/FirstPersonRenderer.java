...
public class FirstPersonRenderer {
   ...
   public void renderItemInFirstPerson(float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer.Impl bufferIn, ClientPlayerEntity playerEntityIn, int combinedLightIn) {
      ...
      if (flag) {
         ...
         if(!net.minecraftforge.client.ForgeHooksClient.renderSpecificFirstPersonHand(Hand.MAIN_HAND, matrixStackIn, partialTicks, f1, f3, f5, this.itemStackMainHand))
      ...
      if (flag1) {
         ...
         if(!net.minecraftforge.client.ForgeHooksClient.renderSpecificFirstPersonHand(Hand.OFF_HAND, matrixStackIn, partialTicks, f1, f4, f6, this.itemStackOffHand))
