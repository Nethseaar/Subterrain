      ...
      if (item instanceof BlockItem) {
         ...
         if (item == Items.SHIELD) {
            ...
            if (flag) {
               ...
               BannerTileEntityRenderer.func_228837_a_(this.banner, matrixStackIn, bufferIn, combinedLightIn, combinedOverlayIn, this.modelShield.func_228293_a_(), material, false);
            } else {
