...
public class TileEntityRendererDispatcher {
   ...
   @Deprecated
   public <E extends TileEntity> void renderItem(E tileEntityIn, MatrixStack matrixStackIn) {
      IRenderTypeBuffer.Impl irendertypebuffer$impl = IRenderTypeBuffer.getImpl(this.fixedRenderBuffer);
      this.renderItem(tileEntityIn, matrixStackIn, irendertypebuffer$impl, 15728880, OverlayTexture.NO_OVERLAY);
