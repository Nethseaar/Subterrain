...
public class BeeEntity extends AnimalEntity implements IFlyingAnimal {
   ...
   private void addParticle(World p_226397_1_, double p_226397_2_, double p_226397_4_, double p_226397_6_, double p_226397_8_, double p_226397_10_, IParticleData p_226397_12_) {
   ...
   private void startMovingTo(BlockPos p_226433_1_) {
   ...
   public void setFlowerPos(BlockPos p_226431_1_) {
   ...
   private void setAnger(int p_226453_1_) {
   ...
   private boolean isTooFar(BlockPos p_226437_1_) {
      return !this.isWithinDistance(p_226437_1_, 48);
   }

   private void setBeeFlag(int p_226404_1_, boolean p_226404_2_) {
      if (p_226404_2_) {
   ...
   private boolean getBeeFlag(int p_226456_1_) {
   ...
   private boolean isFlowers(BlockPos p_226439_1_) {
   ...
   public boolean setBeeAttacker(Entity p_226391_1_) {
   ...
   public class FindBeehiveGoal extends BeeEntity.PassiveGoal {
      ...
      private boolean startMovingToFar(BlockPos p_226472_1_) {
      ...
      private boolean isPossibleHive(BlockPos p_226473_1_) {
         return this.possibleHives.contains(p_226473_1_);
      }

      private void addPossibleHives(BlockPos p_226475_1_) {
         this.possibleHives.add(p_226475_1_);
      ...
      private boolean isCloseEnough(BlockPos p_226476_1_) {
         if (BeeEntity.this.isWithinDistance(p_226476_1_, 2)) {
            return true;
         } else {
            Path path = BeeEntity.this.navigator.getPath();
            return path != null && path.getTarget().equals(p_226476_1_) && path.reachesTarget() && path.isFinished();
         }
      }
   }
   ...
   class PollinateGoal extends BeeEntity.PassiveGoal {
      ...
      private Optional<BlockPos> findFlower(Predicate<BlockState> p_226500_1_, double p_226500_2_) {
