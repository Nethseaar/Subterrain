...
public class BannerTileEntity extends TileEntity implements INameable {
   ...
   private boolean field_226953_k_ = false;
   ...
   @OnlyIn(Dist.CLIENT)
   public void func_226954_a_(boolean p_226954_1_) {
      this.field_226953_k_ = p_226954_1_;
   }

   @OnlyIn(Dist.CLIENT)
   public boolean func_226955_h_() {
      return this.field_226953_k_;
   }
}