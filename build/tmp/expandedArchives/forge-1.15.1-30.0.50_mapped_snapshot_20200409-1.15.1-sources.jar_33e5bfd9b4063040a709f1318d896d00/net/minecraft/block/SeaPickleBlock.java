...
public class SeaPickleBlock extends BushBlock implements IGrowable, IWaterLoggable {
   ...
   public void grow(ServerWorld p_225535_1_, Random rand, BlockPos pos, BlockState p_225535_4_) {
      if (!this.isInBadEnvironment(p_225535_4_) && p_225535_1_.getBlockState(pos.down()).isIn(BlockTags.CORAL_BLOCKS)) {
         int i = 5;
         int j = 1;
         int k = 2;
         int l = 0;
         ...
         for(int k1 = 0; k1 < 5; ++k1) {
            for(int l1 = 0; l1 < j; ++l1) {
               ...
               for(int j2 = i2 - 2; j2 < i2; ++j2) {
                  ...
                  if (blockpos != pos && rand.nextInt(6) == 0 && p_225535_1_.getBlockState(blockpos).getBlock() == Blocks.WATER) {
                     BlockState blockstate = p_225535_1_.getBlockState(blockpos.down());
                     if (blockstate.isIn(BlockTags.CORAL_BLOCKS)) {
                        p_225535_1_.setBlockState(blockpos, Blocks.SEA_PICKLE.getDefaultState().with(PICKLES, Integer.valueOf(rand.nextInt(4) + 1)), 3);
                     }
                  }
               }
            }
         ...
         p_225535_1_.setBlockState(pos, p_225535_4_.with(PICKLES, Integer.valueOf(4)), 2);
      }
